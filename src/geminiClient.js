      ...
      try {
        ...
        if (response.statusCode === 200) {
          try {
            ...
            if (responseJson.error && (responseJson.error.code === 429 || responseJson.error.status === "RESOURCE_EXHAUSTED")) {
              console.log(`[GEMINI::${maskedKey}] Soft rate limited (200 OK with error in body) - trying next key`);
              requestContext.markKeyAsRateLimited(apiKey);
